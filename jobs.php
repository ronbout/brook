			...
			<div id="search-left" class="left <?php echo $search_section_class; ?>">
					<form id="jl-job-search" method="post">
						...
						<div id="radius-search-div">
							...
							<input type="image" id="jl-search-submit" class="btn btn-search" src="<?php echo get_stylesheet_directory_uri(); ?>/images/icon-search.png" alt="submit" >
						</div>
			...
			<div id="search-right" class="right <?php echo $search_section_class; ?>">
				<div class="right-container join-container">
					...
					<p>Sign in to our Career Center where first time users can create a profile and returning job seekers can
						update your profile and resume, check the status of jobs you’ve applied for and manage email alerts about new jobs.
					</p>
		...
		<div id="jl-modal-layer">
			...
			<div id="jl-apply-now-box" class="modalContainer">
				...
				<script id="indeed-apply-js" async="true" >
					var loadIndeedButton=function(){window.IndeedApply||function(a,b){function c(){var c=e.getElementById("indeed-apply-js").attributes["dataindeed-apply-qs"],d="";return c&&""!=c.value&&(d="&"+c.value),["<body onload=\"var d=document;d.getElementsByTagName('head')[0].appendChild(d.createElement('script')).src='",g?b:a,"&ms="+ +new Date,d,"'\"></body>"].join("")}var d=window,e=document,f=document.location.href;d.IndeedApply=d.IndeedApply||{};var h,d=e.body,g=/^https:\/\//.test(f);if(!d)return h=arguments.callee,setTimeout(function(){h(a,b)},100);var j,f=e.createElement("div"),i=e.createElement("iframe");f.style.display="none",d.insertBefore(f,d.firstChild).id="indeed-apply-iframe-holder",i.frameBorder="0",i.id="indeed-apply-iframe",i.allowTransparency="true",f.appendChild(i);try{i.contentWindow.document.open()}catch(k){j="javascript:var d=document.open();d.domain='"+e.domain+"';",i.src=j+"void(0);"}try{var l=i.contentWindow.document;l.write(c()),l.close()}catch(m){i.src=j+'d.write("'+c().replace(/"/g,'\\"')+'");d.close();'}}("https://apply.indeed.com/indeedapply/env?","https://apply.indeed.com/indeedapply/env?https=1")};				
				</script>	
