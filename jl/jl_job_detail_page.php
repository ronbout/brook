...
function get_listings_detail_html($job) {
	...
	?>
	<article id="detail-<?php echo $job['JobNumber']; ?>" data-vid="<?php echo str_replace('"',"'",$job['JobVideoURL']); ?>" data-job_img="<?php echo str_replace('"',"'",$job['JobImageURL']); ?>"
			 ...
			 <?php echo build_data($job['IndApplyData']); ?>	 
			 
			 data-indeed-apply-onclick="jlPostApply"
			 data-indeed-apply-continueURL="<?php echo $job['IndContinueUrl'];?>"
			 data-href="<?php echo $job['ApplyURL'];?>">
...
<?php //				<div class="job-summary"> ?>
					...
					<h5>Job Number</h5>
					<p><?php echo $job['JobNumber']; ?></p>
					<h5>Location</h5>
					<p><?php echo $job['Location']; ?></p>
					<h5>Job Class</h5>
					<p><?php echo $job['Jobclass']; ?></p>
					<h5>Experience</h5>
					<p><?php echo $job['Experiencelevel']; ?></p>
					<h5>Date Created</h5>
